...
<body>
    <div class="container-fluid  text-white text-center">
        <p>
            <h2 class="bg-primary">INGRESO DE DATOS</h2>
        </p>
    </div>
    <div class="container">
       <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
        <form action="EstudianteController.php" method="post" class="">
            <div class="mb-4">
    ...
    <hr>
    <h3 class="text-center text-primary">LISTADO DE ESTUDIANTES</h3>
    <hr>
    <div class="container">
